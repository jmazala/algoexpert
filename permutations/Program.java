...
class Program {
  ...
  //     List<Integer> remainingAL = new ArrayList<>(remaining);
  //     remainingAL.remove(i);
  //     List<Integer> next = new ArrayList<Integer>(taken);
  //     next.add(remaining.get(i));
	// 		permutations(remainingAL, next, answer);
	// 	}
  // }
  
  public static void main(String[] args) {
    System.out.println(Program.getPermutations(new LinkedList<>()));
    List<Integer> list = new LinkedList<>();
    list.add(1);
    list.add(2);
    list.add(3);
    System.out.println(Program.getPermutations(list));
  }
}
